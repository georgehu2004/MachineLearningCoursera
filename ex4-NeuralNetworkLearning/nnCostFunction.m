...
z2 = a1 * Theta1';
a2 = sigmoid(z2);
% Add a0(2)=1 (a subscript 0 superscript (2))
a2 = [ones(size(a2, 1), 1) a2];
z3 = a2 * Theta2';
a3 = sigmoid(z3);
% Recode each element of y to 10-dimensional binary vector
y_recode = zeros(m, num_labels);
for i = 1:m
    y_recode(i, y(i)) = 1;
end
% Cost (without regularization)
J = sum(sum((1/m) * (-y_recode.*log(a3) - (1-y_recode).*log(1-a3))));
